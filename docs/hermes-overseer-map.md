# Hermes Overseer Map for Hamlet's Ghost

Last updated: 2026-04-01

## Purpose

Define how a Hermes agent can become maximally useful to Hamlet's Ghost without collapsing the research engine into a closed loop of self-approval.
...
- prepare candidate review queues for human characterization
...
- keep a ledger of approved, rejected, and still-unreviewed policy ideas
...
- prioritize reviews where judge divergence is high
...
- shadow -> review-cleared: human approval required
- review-cleared -> externally used: human approval required

### 4. Evaluator trust resets
If human characterization suggests MUSE or hermes_evaluator is drifting, humans should authorize:
- evaluator retuning
...
3. Apollo / Athena
   Independent outside and skeptical evaluator lanes.
4. Hermes Overseer
...
5. It routes selected artifacts into a human characterization queue.
...
- evaluator divergence stays above threshold
...
- human characterization contradicts evaluator confidence
...
- change prompt policies that affect externally used flows
- alter evaluator prompts or weights
- promote from shadow to review-cleared
...
- remove human characterization from the loop
...
- characterization queue manager
...
4. Add a characterization queue selector that samples promoted, discarded, and disagreement cases.
...
The best version is not “AI runs the research engine alone.”
The best version is “AI keeps Hamlet's Ghost honest, legible, and fast, while humans remain the characterization reference for meaningful quality judgments.”
