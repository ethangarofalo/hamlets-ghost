...
_APOLLO_BACKEND_RAW = os.getenv("APOLLO_BACKEND", os.getenv("HERMES_EXTERNAL_BACKEND", "hermes_cli")).strip().lower()
...
APOLLO_MODEL = os.getenv("APOLLO_MODEL", os.getenv("HERMES_EXTERNAL_MODEL", "gpt-5.4"))
GENESIS_OPENCLAW_MODEL = os.getenv("GENESIS_OPENCLAW_MODEL", os.getenv("OPENCLAW_MODEL", "openclaw/latest"))
THERON_MODEL = os.getenv("THERON_MODEL", os.getenv("THERON_OPENCLAW_MODEL", "anthropic/claude-opus-4-7"))
